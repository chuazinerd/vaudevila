...
<form action="../Controller/Navegacao.php" method="post" class="w3-container  w3-text-blue w3-margin w3-display-middle"
    style="width: 30%;">
    ...
    <!--Campo primeiro acesso do email-->
    <div class="w3-row w3-section">
        <div class="w3-col" style="width:11%;">
    ...
    <!--Campo primeiro acesso do endereco-->
    <div class="w3-row w3-section">
        <div class="w3-col" style="width:11%;">
            <i class="w3-xxlarge fa fa-map-marker"></i>
        </div>
        <div class="w3-rest">
            <input class="w3-input w3-border w3-round-large" name="txtEndereco" type="text"
