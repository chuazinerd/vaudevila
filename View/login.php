...
<body>
    <form action="../Controller/Navegacao.php" method="post" class="w3-container   w3-text-blue w3-margin w3-display-middle" style="width: 30%;">
        ...
        <div class="w3-row w3-section">
            ...
            <div class="w3-rest">
                <input class="w3-input w3-border w3-round-large" name="txtLogin"  placeholder="Login CPF (ex.: 25533327897)">
            </div>
        </div>
        <div class="w3-row w3-section">
        ...
        <div class="w3-center">
            <button name="btnADM" class="w3-block w3 w3-blue w3-cell w3-round-large"
