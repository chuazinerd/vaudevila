...
?>
    <form action="../Controller/Navegacao.php" method="post"
        class="w3-container  w3-text-blue w3-margin w3-display-middle"
        style="width: 30%;">
        ...
        <div class="w3-row w3-section">
            <div>
                <button name="btnListarCadastrados" class="w3-button w3-block w3-margin w3-blue w3-cell w3-round-large"
